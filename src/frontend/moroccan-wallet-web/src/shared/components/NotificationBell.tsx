...
export function NotificationBell({ unreadCount }: { unreadCount: number }) {
  return (
    ...
    >
      ...
      {unreadCount > 0 ? (
        <span className="absolute right-2 top-2 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-rose-500 px-1.5 text-[11px] font-semibold leading-none text-white">
